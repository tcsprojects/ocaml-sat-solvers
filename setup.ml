...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3a6971272b18b3f6dd2e6e53d471894d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.08.0");
          version = "0.7";
          license =
          ...
          homepage = Some "https://github.com/tcsprojects/ocaml-sat-solvers";
          bugreports = None;
          synopsis =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/tcsprojects/ocaml-sat-solvers.git";
                      src_repo_browser =
                        Some
                          "https://github.com/tcsprojects/ocaml-sat-solvers";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("z3",
                               Some (OASISVersion.VGreaterEqual "4.8.11"))
                        ];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Satwrapper";
                           "Timing";
                           "pseudosat/Pseudosatwrapper";
                           "preprocessor/Preprocessor";
                           "externalsat/Externalsat";
                           "externalsat/Satsolutionlexer";
                           "externalsat/Satsolutionparser";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ocaml-sat-solvers"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "tester1.ml"});
               Executable
                 ({
                     cs_name = "tester2";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "tester2.ml"})
            ];
     ...
     oasis_digest = Some "X|\207d\130q\002\252V\160\168\213HZ\025\163";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
