...
(* OASIS_START *)
(* DO NOT EDIT (digest: 08b355aac11120590185a7b8abecb5d3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "This library contains an abstraction layer for integrating SAT\nSolvers into OCaml.";
          description =
            Some
              [
                 OASISText.Para
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("minisat", None)];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["minisat/Minisatwrapper"; "Satsolverregistry"];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\233\195\168\003\136\168\149\173\225\216\027\240\188g\174\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
